...
def main(args):
    ...
    # We render our own outer per-image bar, so silence the inner per-step bar
    # that diffusers prints for every pipe(...) call.
    ...
    pbar = tqdm(total=end_index - start_index, unit="img", desc="gen_data")
